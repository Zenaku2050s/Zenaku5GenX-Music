...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("Zenaku5GenX-Music/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('Zenaku5GenX-Music/assets/font.ttf', 30)
            font2 = ImageFont.truetype('Zenaku5GenX-Music/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('Zenaku5GenX-Music/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('Zenaku5GenX-Music/assets/font2.ttf', 35)
