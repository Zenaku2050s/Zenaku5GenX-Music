...
def welcomepic(pic, user, chatname, id, uname):
    ...
    font = ImageFont.truetype('Zenaku5GenX-Music/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('Zenaku5GenX-Music/assets/font.ttf', size=60)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "Zenaku5GenX-Music/assets/dil.png"
