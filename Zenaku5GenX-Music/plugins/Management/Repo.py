...
from Zenaku5GenX-Music import app as bot
import requests
from config import BOT_USERNAME
from Zenaku5GenX-Music.utils.errors import capture_err
...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("ᴠ1 ᴍᴜsɪᴄ", url=f"https://github.com/stkeditz/Zenaku5GenX-MusicMUSIC"),
          InlineKeyboardButton("︎ᴠ2 ᴍᴜsɪᴄ", url=f"https://github.com/stkeditz/Zenaku5GenX-MusicMUSICv2"),
        ],
        [
          InlineKeyboardButton("ᴍᴀñᴀɢᴇᴍᴇɴᴛ", url=f"https://github.com/BadshahAk/AnsiRobot"),
          InlineKeyboardButton("ᴄʜᴀᴛ ʙᴏᴛ", url=f"https://github.com/stkeditz/Zenaku5GenX-MusicCHATBOT"),
        ],
        [
          InlineKeyboardButton("sᴛʀɪɴɢ ʙᴏᴛ", url=f"https://github.com/stkeditz/Zenaku5GenX-MusicSTRINGBOT"),
...
async def repo(_, message):
    async with httpx.AsyncClient() as client:
        response = await client.get("https://api.github.com/repos/stkeditz/Zenaku5GenX-MusicMUSICv2/contributors")
    ...
    if response.status_code == 200:
        ...
        text = f"""[ʀᴇᴘᴏ](https://github.com/stkeditz/Zenaku5GenX-MusicMUSICv2) | [𝖦𝖱𝖮𝖴𝖯](https://t.me/alonegroup121)
| ᴄᴏɴᴛʀɪʙᴜᴛᴏʀs |
----------------
{list_of_users}"""
